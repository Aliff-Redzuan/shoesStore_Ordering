...
Route::get(
    '/customer/shop',
    [CustomerController::class, 'shop']
)->name('customer.shop');


Route::get(
    '/customer/settings',
    [CustomerController::class, 'settings']
)->name('customer.settings');


Route::put(
    '/customer/settings',
    [CustomerController::class, 'updateSettings']
...
Route::prefix('customer')->name('customer.')->group(function () {
    ...
    */
    ...
    Route::get(
        '/cart',
        [CustomerController::class, 'viewCart']
    )->name('cart.index');
    ...
    Route::delete(
        '/cart/{key}',
        [CustomerController::class, 'removeFromCart']
    )->name('cart.remove');
    ...
    */
    ...
    Route::get(
        '/checkout',
        [CustomerController::class, 'showCheckout']
    )->name('checkout.show');


    Route::post(
        '/checkout',
        [CustomerController::class, 'processCheckout']
    ...
    */
    ...
    Route::get(
        ...
        [CustomerController::class, 'orderConfirmation']
...
Route::prefix('staff')->name('staff.')->group(function () {
    ...
    */
    ...
    Route::get(
        '/orders',
        [StaffController::class, 'orders']
    )->name('orders.index');


    Route::get(
        '/orders/{id}',
        [StaffController::class, 'showOrder']
    )->name('orders.show');
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    */
    ...
    Route::get(
        '/manage',
        [AdminController::class, 'manage']
    )->name('manage');


    Route::post(
        '/staff',
        [AdminController::class, 'staffStore']
    )->name('staff.store');


    Route::patch(
        '/staff/{id}/toggle',
        [AdminController::class, 'staffToggle']
    )->name('staff.toggle');
